    ...
    <q-markup-table :separator="'cell'" flat bordered>
      <thead>
        <tr>
          ...
          <th class="text-center"><b>ENTRA</b></th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td class="text-center">
            <q-input
              type="date"
              v-model="model.fechaEntrada"
              style="width: 120px; padding: 0px"
              @update:model-value="save('isVariableEntrada')"
              :rules="[required]"
            />
          </td>
        ...
        <tr>
          ...
          <td class="text-right">
            <q-input
              style="width: 150px; padding: 0px"
              v-model="model.aceiteMotorEntrada"
              @update:model-value="save('isVariableEntrada')"
              :rules="[required]"
            >
            </q-input>
        ...
        <tr>
          ...
          <td class="text-right">
            <q-input
              ...
              v-model="model.aceiteHidraEntrada"
              @update:model-value="save('isVariableEntrada')"
              :rules="[required]"
            >
            </q-input>
...
import CAUCHO from "../entrada/entradaRadioEnt.vue";
